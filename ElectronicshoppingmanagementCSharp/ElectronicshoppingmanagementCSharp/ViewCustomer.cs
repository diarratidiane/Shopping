...
namespace ElectronicShoppingManagementSystemCSharp
{
    public partial class ViewCustomer : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'electronicDataSet.cust' table. You can move, or remove it, as needed.
            this.custTableAdapter.Fill(this.electronicDataSet.cust);
